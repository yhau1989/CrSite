                            ...
                            <div class="ui fluid card">
                                <?php foreach ($stock['data'] as $clave => $valor) { ?>
                                    ...
                                    <div class="content">
                                        ...
                                        <?php echo $valor['stock'] . MEDIDA_PESO; ?> 
            ...
            <div class="thirteen wide column">
                ...
                <div>
                    ...
                    <div class="ui accordion">
                        <div class="title">
                            <h3 class="ui dividing header">
                                <i class="dropdown icon"></i> Compras del día
                            </h3>
                        </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($compras['data'] as $clave => $valor) { ?>
                                            <tr>
                                                ...
                                                <td data-label="peso_total"><?php echo $valor['peso_total'] . MEDIDA_PESO;  ?></td>
                    ...
                    <div class="ui accordion">
                        ...
                        <div class="title">
                            <h3 class="ui dividing header">
                                <i class="dropdown icon"></i> Ventas del día
                            </h3>
                        </div>
                    ...
                    <div class="ui accordion">
                        ...
                        <div class="title">
                            <h3 class="ui dividing header">
                                <i class="dropdown icon"></i> ODT del día
                            </h3>
                        </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($odt['data'] as $clave => $valor) { ?>
                                                <tr>
                                                    ...
                                                    <td data-label="peso"><?php echo $valor['peso_total'] . MEDIDA_PESO; ?></td>
                                                    <td data-label="faltante"><?php echo $valor['faltante'] . MEDIDA_PESO; ?></td>
