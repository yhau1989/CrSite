...
class Stock_model extends CI_Model {
    ...
    public function __construct()
    {
            ...
            $this->load->database();
            $this->table_name = 'stockmateriales';
    }
    ...
    public function getStocks()
    {
        try {
            ...
            $this->db->select("tipomateriales.tipo, stockmateriales.stock");
            $this->db->from($this->table_name);
            $this->db->join('tipomateriales', 'tipomateriales.id = stockmateriales.id_material','inner');
            $data = $this->db->get(); 
            ...
            {
                return $this->setErrorMesaage(1, 'No existen Stocks');
            }
            else
            {
